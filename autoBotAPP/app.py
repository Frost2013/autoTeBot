...
# Запуск Flask и Telegram-бота в одном процессе с использованием asyncio
if __name__ == "__main__":
    loop = asyncio.get_event_loop()
    loop.create_task(run_flask())  # Запуск Flask
    loop.create_task(run_telegram_bot())  # Запуск Telegram бота
